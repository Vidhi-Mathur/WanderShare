            ...
            <div className="glass-card rounded-2xl p-8 md:p-10 backdrop-blur-xl border border-white/50 shadow-xl">
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm text-gray-600">
                        {signup ? "Start sharing your travel stories today" : "Access your wandering journey"}
                    </p>
                </div>
                <form onSubmit={submitHandler} className="space-y-5">
                    ...
                    <div>
                        ...
                        <div className="relative">
                          <input id="password" type="password" name="password" value={formData.password} onChange={changeHandler} placeholder={signup ? "Create a strong password" : "Enter your password"} className="w-full px-4 py-3 rounded-lg bg-white/50 border border-gray-200 focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-200 transition-all duration-300 placeholder-gray-400" required />
                        </div>
                    </div>
                    {signup && (
