...
import { Upload, MapPin, X, Loader2, CheckCircle2 } from "lucide-react"
import { LocationPicker } from "./LocationPicker"

let requirementConstants = ["Clear, descriptive name that identifies the location", "Detailed description with travel tips and experiences", "High-quality photos that showcase the place", "Accurate GPS coordinates for the location"]
    ...
    if(submitted) {
        return (
            <div className="glass-card rounded-2xl p-12 text-center backdrop-blur-xl border border-white/50 shadow-xl">
                ...
                <h2 className="font-playfair text-3xl font-bold text-green-900 mb-2">Place Added Successfully!</h2>
                <p className="text-gray-600">Your destination will be reviewed and appear on WanderShare shortly.</p>
            </div>
        )
    }
        ...
        <form onSubmit={submitHandler} className="space-y-8">
            ...
            <div className="glass-card rounded-2xl p-8 md:p-10 backdrop-blur-xl border border-white/50 shadow-xl">
                ...
                <div className="space-y-3 mb-8">
                    ...
                    <textarea id="description" name="description" value={formData.description} onChange={changeHandler} placeholder="Share details about this place, what makes it special, best time to visit, travel tips..." className="w-full px-4 py-3 rounded-lg bg-white/60 border border-emerald-200 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-200 transition-all duration-300 placeholder-gray-400 text-gray-800 min-h-32 resize-none" required />
                </div>
                <div className="space-y-3 mb-8">
